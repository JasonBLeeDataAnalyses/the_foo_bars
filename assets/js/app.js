...
d3.csv("data/advanced.csv", function(data) { //d3.csv("assets/data/data.csv", function(data)
  // Visualize the data
  visualize(data);
});
...
function visualize(theData) {
  // PART 1: Essential Local letiables and Functions
  // =================================
  ...
  let toolTip = d3
    ...
    .html(function(d) {
      ...
      let thePlayer = "<div>" + d.Player + "</div>";
